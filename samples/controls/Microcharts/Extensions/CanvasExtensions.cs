...
namespace Microcharts
{
    ...
    {
        public static void DrawCaptionLabels(this ICanvas canvas, string label, SKColor labelColor, string value, Color valueColor, float textSize, Point point, SKTextAlign horizontalAlignment, SKTypeface typeface, out SKRect totalBounds)
        {
        ...
        public static void DrawPoint(this ICanvas canvas, SKPoint point, SKColor color, float size, PointMode mode)
        {
            using (var paint = new SKPaint
            {
        ...
        public static void DrawGradientLine(this ICanvas canvas, SKPoint startPoint, SKColor startColor, SKPoint endPoint, SKColor endColor, float size)
        {
        ...
        public static void DrawTextCenteredVertically(this ICanvas canvas, string text, SKPaint paint, SKPoint point)
        {
        ...
        /// <remarks>https://stackoverflow.com/questions/27631736/meaning-of-top-ascent-baseline-descent-bottom-and-leading-in-androids-font</remarks>
        public static void DrawTextCenteredVertically(this ICanvas canvas, string text, SKPaint paint, float x, float y)
        {
        ...
        /// <returns></returns>
        private static Rect GetAbsolutePositionRect(float x, float y, Rect bounds, SKTextAlign horizontalAlignment)
        {
