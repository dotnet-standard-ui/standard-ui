...
namespace Microcharts
{
    ...
    {
        public SeriesChart(IChart control) : base(control)
        {
        }
        ...
        /// internal series
        /// </summary>
        protected IEnumerable<ChartSeries> series;
        ...
        protected virtual void UpdateSeries(IEnumerable<ChartSeries> value)
        {
        ...
        {
            get => entries;
            set => GenerateDefaultSeries(value);
        }
        ...
        protected virtual void GenerateDefaultSeries(IEnumerable<ChartEntry> value)
        {
            UpdateSeries(new ChartSeries[]
            {
                new ChartSeries()
                {
